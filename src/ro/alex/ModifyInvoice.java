...
public class ModifyInvoice {
    ...
    public static void modifyCompanyName(int index, String companyName) {
    ...
    public static void modifySN(int index, int serialNumber) {
        Invoice returnInvoice = invoices.get(index);
        returnInvoice = returnInvoice.withSerialNumber(serialNumber);
        invoices.remove(index);
        invoices.add(index, returnInvoice);
    }
    ...
    public static void modifyCif(int index, int cif) {
        Invoice returnInvoice = invoices.get(index);
